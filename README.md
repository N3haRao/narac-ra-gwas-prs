...
### 2️⃣ Run QC → PCA → GWAS → PRS

```
bash scripts/GWAS-Analysis-Pipeline.sh
```

---

### 3️⃣ Run Mixed Model GWAS

```
Rscript scripts/GMMAT.R
```

---

### 4️⃣ Run LD Score Regression (optional)

```
bash scripts/ldscore.sh
```
